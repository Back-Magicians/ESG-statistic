...
BUTTON_XPATH = '//div[@class="list-more color-btn-second-hover" and contains(text(), "Еще 20 материалов")]'
CSV_HEADERS = ["Заголовок", "Компания", "Дата публикации", "Текст"]
RIA_URL = "https://ria.ru/organization_Sberbank_Rossii/"
TARGET_ARTICLE = "В Новосибирске задержали мужчину, бросившего петарды в банк"
TEST_FILENAME = "test_ria_data.csv"
